...
financial: {
    ...
    COUNTIF : function(range, criteria) {console.log(range);
        var matches = 0, i;
        for (i in range) {
...
};cell.fx.buildInputPanels = function(address, currentPanel){
			
	var a, panel = '';
	var currentPanel = currentPanel || 1;
		...
		for(a in this.dependencies){
			...
			if(cellType != 'U') {
				...
				panel += 	'<div class="panel-heading">\
								<h5 class="panel-title collapsed" href="#panel' + currentPanel + '" data-toggle="collapse" aria-expanded="false">\
				...
				if(!$.isEmptyObject(this.dependencies[a].dependencies)){
					panel += '<div id="panel' + currentPanel + '" class="panel-collapse collapse" aria-expanded="false" style="height: 0px; margin: 0 0 0 15px; padding: 10px; background-color: #eee; border-left: 3px solid blue;">';
					currentPanel++;
					...
					for(b in this.dependencies[a].dependencies){
						...
						if(inputCellType != 'U'){
							var inputLabel = $('#'+b).closest('.form-group').find('label').html();
					...
					var panelInputs = 	this.dependencies[a].buildInputPanels(address, currentPanel++);

...
var Buttons_Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addTablePopoverButtons() {
      ...
      this.context.memo('button.removeBorder', function() {
        return _this5.button({
          className: 'btn-md',
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    popover: {
      ...
      table: [['add', ['addRowDown', 'addRowUp', 'addColLeft', 'addColRight', 'removeBorder']], ['delete', ['deleteRow', 'deleteCol', 'deleteTable']]],
...
var dialog = renderer["a" /* default */].create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="modal-dialog">', '<div class="modal-content">', options.title ? '<div class="modal-header">' + '<div class="close-modal" data-dismiss="modal">✖</div>' + '<h2 class="modal-title">' + options.title + '</h2>' + '</div>' : '', '<div class="modal-body">' + options.body + '</div>', options.footer ? '<div class="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
});

<?php
	...
	require_once("$root/enterprise/9/db/db_interaction.php");
...
?>
		...
		<script src="assets/sticky/js/sticky.js"></script>
		...
		<script src="assets/table/js/roishop.table.js"></script>
		<script src="assets/table/js/roishop.jexcel.js"></script>
		<script src="assets/table/js/jsuites.js"></script>
		<script src="assets/starrr/js/starrr.js"></script>
		<script src="assets/enterprise/js/calc.functions.js"></script>
		<script src="assets/waiting/js/waitingfor.js"></script>

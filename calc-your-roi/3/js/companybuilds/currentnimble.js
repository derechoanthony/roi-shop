$(document).ready(function() {
	...
	var testInputs = {
		elements: [{
			...
			header: {
				text: '<h1 style="margin-bottom: 20px;">ROI Dashboard | 6 Year Projection</h1>'
			}
		},{
			type: 'holder',
				...
				elements: [{
					...
					elements: [{
						...
						elements: [{
							...
							tag: 'a',
							link: '#section2',
							text: '<h2 class="section-header" style="font-size: 26px; height: 28px;">Inputs</h2>'
						},{
							type:	'text',
							text: '<h1 class="txt-right pod-total section-total txt-money" data-format="($0,0)" data-formula="( GT2 - GT1 )">$0</h1>'
						}]
					}]					
				}]
			}]

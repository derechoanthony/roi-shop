<?php
	...
	require "$root/webapps/core/functions/macros.php";								// This is where the functions for each macro are stored
	require "$root/webapps/core/functions/marketo.php";								// This is where the functions for each macro are stored
	...
	switch ($stdmacro) {
		...
		case 1:	
			//This is the standard ROI Finish Macro that creates the pdf and sends the emails
			//$nextaction = $m->PushLeadToMarketo($instanceID, 1);
			$nextaction = $m->FinishROI($instanceID, $aurgs);
			echo $nextaction;
			break;
		case 2:

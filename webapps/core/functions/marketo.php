...
class PushLeads{
	public $host; //= "https://852-MYR-807.mktorest.com";//CHANGE ME
	public $clientId; // = "c577287e-cf66-4ea1-861b-f797eba88716";//CHANGE ME
	public $clientSecret; // = "lYsuAwsFfV4O8HiBDRQR6Qsv34nGMZhn";//CHANGE ME
	...
	public function csvString($fields){
		$csvString = "";
		$i = 0;

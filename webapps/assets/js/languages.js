...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('gbp', language);
    }
}());
/*! 
 * numeral.js language configuration
...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('en-es', language);
    }
}());
...
// numeral.js language configuration
// language : English United States and territories
// author : Jacob Achorn
(function () {
    var language = {
        delimiters: {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('usd', language);
    }
}());

// numeral.js language configuration
// language : Singapore Dollar
// author : Chris Rudd
(function () {
    var language = {
        delimiters: {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('sgd', language);
    }
}());
...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('can', language);
    }
}());
...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('eur', language);
    }
}());
...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('eur-si', language);
    }
}());
...
(function () {
    ...
    // Browser
    if (typeof window !== 'undefined' && this.numeral && this.numeral.language) {
        this.numeral.language('aud', language);
    }
}());
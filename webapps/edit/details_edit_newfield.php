...
<div class="col-sm-12">
		...
		<?php include 'details_tab_edit_newfield.php';?>
...
<script>
         ...
         $('.savefield').click(function(){
         	console.log('save new field');
         	
         	var data = $('#newfield').serialize();
         	
         	$.ajax({
			type	: 	"POST",
			url		:	"ajax_newfield.php",
		...
		$.ajax({
			type	: 	"POST",
			url		:	"ajax_savecode.php",
			data	:	'reportid=' + reportID + '&csshtml=' + css1 + '&html=' + html1 + '&script=' + script1,
			success	:	function(returnhtml) {
				console.log(returnhtml);

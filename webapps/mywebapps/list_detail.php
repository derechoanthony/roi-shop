		...
		$rowdata = $rowdata . '<tr>
         ...
         $rowdata = $rowdata . $pageinfo . '</td>
         						<td class="project-actions">
         							<a href="../preview/?wbappID=' . $r['wb_roi_ID'] . '&key=' . $r['key'] . '" class="btn btn-success btn-sm"><i class="fa fa-pencil"></i> View </a>
                                    <a href="#" class="btn btn-white btn-sm"><i class="fa fa-files-o"></i> Copy </a>

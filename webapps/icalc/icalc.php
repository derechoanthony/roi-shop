...
<?php 
	...
	echo '<input type="hidden" id="countrystdfield" value="' . $country . '"> ';
	echo '<input type="hidden" id="statestdfield" value="' . $state . '"> ';
	echo '<input type="hidden" id="citystdfield" value="' . $city . '"> ';

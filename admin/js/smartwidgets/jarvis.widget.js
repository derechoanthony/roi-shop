            ...
            if (self.o.sortable === true && jQuery.ui) {
                ...
                sortItem.sortable({
                    ...
                    update: function (event, ui) {
						...
						$('.sectionwidget').each( function( i, v ) {
							$.ajax({
								type	: 	"POST",
								url		:	"../admin/ajax/ajaxcalls.php",
								data	:	{ 'action' : 'reorderSection', 'id': $(this).data('section-id'), 'pos': i + 1 },
								success	:	function( ) {
									localStorage.clear();
								}
							});
						...
						$('.entrywidget').each( function( i, v ) {
							$.ajax({
								type	: 	"POST",
								url		:	"../admin/ajax/ajaxcalls.php",
								data	:	{ 'action' : 'reorderEntry', 'id': $(this).data('entry-id'), 'pos': i + 1 },
								success	:	function( ) {
									localStorage.clear();
								}
							});
